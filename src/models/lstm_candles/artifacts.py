...
from src.models.lstm_candles.trainer import TrainedLstmCandlesModel
...
class LstmCandlesArtifactWriter:
    ...
    def save_production_model(self, trained: TrainedLstmCandlesModel) -> ArtifactPaths:
    ...
    def build_model_payload(self, trained: TrainedLstmCandlesModel) -> dict[str, Any]:
        return {
            ...
            "symbols": list(trained.symbols),
            "model_args": trained.model_args,
            "training": trained.training_summary,
        }

    def build_metadata(self, trained: TrainedLstmCandlesModel) -> ModelMetadata:
        return ModelMetadata(
            ...
            feature_clip={
                "enabled": False,
                "bounds": {},
                "note": "Candle LSTM uses sequence standardization instead of feature clipping.",
            },
    ...
    def build_metrics_payload(self, trained: TrainedLstmCandlesModel) -> dict[str, Any]:
        return {
            "model_key": self.spec.key,
            "artifact_name": self.spec.artifact_name,
    ...
    @staticmethod
    def build_train_period(trained: TrainedLstmCandlesModel) -> dict[str, str] | None:
